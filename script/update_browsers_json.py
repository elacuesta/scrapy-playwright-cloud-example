"""
Update the default browsers.json file in order to only download the necessary binaries
"""
...
def update_browsers_json():
    ...
    browsers["browsers"] = [b for b in browsers["browsers"] if b["name"] in ("chromium", "firefox")]
